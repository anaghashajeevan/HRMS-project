...
// // ==============================================================================
// // PERFORMANCE MANAGEMENT API — NEW MONTHLY/ANNUAL SERVICE
// // ==============================================================================

// import api from './axios';
// import type {
//   CommonKRAMaster,
//   DepartmentalKRAMaster,
//   AnnualPerformancePlanListItem,
...
// // Helper to unwrap list
// function unwrap<T>(data: { results: T[] } | T[]): T[] {
//   return Array.isArray(data) ? data : data.results;
// }

// // ------------------------------------------------------------------------------
// // COMMON KRA MASTER API (HR Settings)
// // ------------------------------------------------------------------------------

// export const commonKRAApi = {
//   list: async (params?: { financial_year?: string; is_active?: boolean }): Promise<CommonKRAMaster[]> => {
//     const { data } = await api.get('/common-kras/', { params });
//     return unwrap(data);
//   },

//   create: async (payload: Partial<CommonKRAMaster>): Promise<CommonKRAMaster> => {
//     const { data } = await api.post<CommonKRAMaster>('/common-kras/', payload);
//     return data;
//   },

//   update: async (id: string, payload: Partial<CommonKRAMaster>): Promise<CommonKRAMaster> => {
//     const { data } = await api.patch<CommonKRAMaster>(`/common-kras/${id}/`, payload);
//     return data;
//   },

//   delete: async (id: string): Promise<void> => {
//     await api.delete(`/common-kras/${id}/`);
//   },
// };
// // ==============================================================================
...
// };
// // ------------------------------------------------------------------------------
// // DEPARTMENTAL KRA MASTER API (HR Settings)
// // ------------------------------------------------------------------------------

// export const deptKRAApi = {
//   list: async (params?: { financial_year?: string; department?: string; is_active?: boolean }): Promise<DepartmentalKRAMaster[]> => {
//     const { data } = await api.get('/dept-kras/', { params });
//     return unwrap(data);
//   },

//   create: async (payload: Partial<DepartmentalKRAMaster>): Promise<DepartmentalKRAMaster> => {
//     const { data } = await api.post<DepartmentalKRAMaster>('/dept-kras/', payload);
//     return data;
//   },

//   update: async (id: string, payload: Partial<DepartmentalKRAMaster>): Promise<DepartmentalKRAMaster> => {
//     const { data } = await api.patch<DepartmentalKRAMaster>(`/dept-kras/${id}/`, payload);
//     return data;
//   },

//   delete: async (id: string): Promise<void> => {
//     await api.delete(`/dept-kras/${id}/`);
//   },
// };

// // ------------------------------------------------------------------------------
// // ANNUAL PERFORMANCE PLANS API
// // ------------------------------------------------------------------------------

// export const annualPlansApi = {
//   list: async (params?: { financial_year?: string; status?: string; employee?: string }): Promise<AnnualPerformancePlanListItem[]> => {
//     const { data } = await api.get('/annual-plans/', { params });
//     return unwrap(data);
//   },

//   getById: async (id: string): Promise<AnnualPerformancePlanDetail> => {
//     const { data } = await api.get<AnnualPerformancePlanDetail>(`/annual-plans/${id}/`);
//     return data;
//   },

//   getMyPlan: async (fy: string = '2026-27'): Promise<AnnualPerformancePlanDetail> => {
//     const { data } = await api.get<AnnualPerformancePlanDetail>('/annual-plans/my-plan/', {
//       params: { fy },
//     });
//     return data;
//   },

//   generate: async (payload: { employee_id: string; financial_year: string }): Promise<AnnualPerformancePlanDetail> => {
//     const { data } = await api.post<AnnualPerformancePlanDetail>('/annual-plans/generate/', payload);
//     return data;
//   },
// };

// // ------------------------------------------------------------------------------
// // MONTHLY PERFORMANCE PLANS API
// // ------------------------------------------------------------------------------

// export const monthlyPlansApi = {
//   getById: async (id: string): Promise<MonthlyPerformancePlan> => {
//     const { data } = await api.get<MonthlyPerformancePlan>(`/monthly-plans/${id}/`);
//     return data;
//   },

//   update: async (id: string, payload: Partial<MonthlyPerformancePlan>): Promise<MonthlyPerformancePlan> => {
//     const { data } = await api.patch<MonthlyPerformancePlan>(`/monthly-plans/${id}/`, payload);
//     return data;
//   },
// };

// // ------------------------------------------------------------------------------
// // MONTHLY KRAs & KPIs API
// // ------------------------------------------------------------------------------

// export const monthlyKRAsApi = {
//   create: async (payload: Partial<MonthlyKRA>): Promise<MonthlyKRA> => {
//     const { data } = await api.post<MonthlyKRA>('/monthly-kras/', payload);
//     return data;
//   },

//   update: async (id: string, payload: Partial<MonthlyKRA>): Promise<MonthlyKRA> => {
//     const { data } = await api.patch<MonthlyKRA>(`/monthly-kras/${id}/`, payload);
//     return data;
//   },

//   delete: async (id: string): Promise<void> => {
//     await api.delete(`/monthly-kras/${id}/`);
//   },
// };

// export const monthlyKPIsApi = {
//   create: async (payload: Partial<MonthlyKPI>): Promise<MonthlyKPI> => {
//     const { data } = await api.post<MonthlyKPI>('/monthly-kpis/', payload);
//     return data;
//   },

//   update: async (id: string, payload: Partial<MonthlyKPI>): Promise<MonthlyKPI> => {
//     const { data } = await api.patch<MonthlyKPI>(`/monthly-kpis/${id}/`, payload);
//     return data;
//   },

//   delete: async (id: string): Promise<void> => {
//     await api.delete(`/monthly-kpis/${id}/`);
//   },

//   uploadEvidence: async (formData: FormData): Promise<MonthlyKPIEvidence> => {
//     const { data } = await api.post<MonthlyKPIEvidence>('/monthly-kpi-evidences/', formData, {
//       headers: { 'Content-Type': 'multipart/form-data' },
//     });
//     return data;
//   },
...
// export const peerNominationsApi = {
//   list: async (params?: { monthly_kra?: string }) => {
//     const { data } = await api.get('/monthly-peer-nominations/', { params });
//     return Array.isArray(data) ? data : data.results;
//   },
//   nominate: async (payload: { monthly_kra_id: string; peer_ids: string[] }) => {
//     const { data } = await api.post('/monthly-peer-nominations/nominate-peers/', payload);
//     return data;
//   },
//   delete: async (id: string) => {
//     await api.delete(`/monthly-peer-nominations/${id}/`);
//   },
// };

// export const peerRatingsApi = {
//   myPendingReviews: async () => {
//     const { data } = await api.get('/monthly-peer-ratings/my-pending-reviews/');
//     return data;
//   },
...
//   }) => {
//     const { data } = await api.post(`/monthly-peer-ratings/${id}/submit/`, payload);
//     return data;
//   },
//   decline: async (id: string, payload: { decline_reason: string }) => {
//     const { data } = await api.post(`/monthly-peer-ratings/${id}/decline/`, payload);
//     return data;
//   },
// };
...
// ==============================================================================
// PERFORMANCE MANAGEMENT API — COMPLETE
// ==============================================================================
...
// ==============================================================================
// COMMON KRA MASTER API (Auto-injects into Monthly Plans)
// ==============================================================================
export const commonKRAApi = {
  list: async (params?: { financial_year?: string; is_active?: boolean }): Promise<CommonKRAMaster[]> => {
    const { data } = await api.get('/common-kras/', { params });
...
export const annualPlansApi = {
  ...
  getMyPlan: async (fy: string = '2026-27'): Promise<AnnualPerformancePlanDetail> => {
    const { data } = await api.get<AnnualPerformancePlanDetail>('/annual-plans/my-plan/', { params: { fy } });
    return data;
  },
  generate: async (payload: { employee_id: string; financial_year: string }): Promise<AnnualPerformancePlanDetail> => {
    const { data } = await api.post<AnnualPerformancePlanDetail>('/annual-plans/generate/', payload);
...
export const monthlyKPIsApi = {
  ...
  deleteEvidence: async (evidenceId: string): Promise<void> => {
    await api.delete(`/monthly-kpi-evidences/${evidenceId}/`);
  },
};
...
// ==============================================================================
// LEGACY EXPORTS (kept alive for old settings pages until removed)
// These continue to power RatingScalePage, OrgPrioritiesPage, KRALibraryPage, etc.
// ==============================================================================

// Rating Scales
export const ratingScalesApi = {
  list: async (params?: any): Promise<any[]> => {
    const { data } = await api.get('/rating-scales/', { params });
    return unwrap(data);
  },
  getById: async (id: string): Promise<any> => {
    const { data } = await api.get(`/rating-scales/${id}/`);
    return data;
  },
  create: async (payload: any): Promise<any> => {
    const { data } = await api.post('/rating-scales/', payload);
    return data;
  },
  update: async (id: string, payload: any): Promise<any> => {
    const { data } = await api.patch(`/rating-scales/${id}/`, payload);
    return data;
  },
  delete: async (id: string): Promise<void> => {
    await api.delete(`/rating-scales/${id}/`);
...
export const orgPrioritiesApi = {
  list: async (params?: any): Promise<any[]> => {
    const { data } = await api.get('/organizational-priorities/', { params });
    return unwrap(data);
  },
  create: async (payload: any): Promise<any> => {
    const { data } = await api.post('/organizational-priorities/', payload);
    return data;
  },
  update: async (id: string, payload: any): Promise<any> => {
    const { data } = await api.patch(`/organizational-priorities/${id}/`, payload);
    return data;
  },
  delete: async (id: string): Promise<void> => {
    await api.delete(`/organizational-priorities/${id}/`);
...
export const kraLibraryApi = {
  list: async (params?: any): Promise<any[]> => {
    const { data } = await api.get('/kra-library/', { params });
    return unwrap(data);
  },
  getById: async (id: string): Promise<any> => {
    const { data } = await api.get(`/kra-library/${id}/`);
    return data;
  },
  create: async (payload: any): Promise<any> => {
    const { data } = await api.post('/kra-library/', payload);
    return data;
  },
  update: async (id: string, payload: any): Promise<any> => {
    const { data } = await api.patch(`/kra-library/${id}/`, payload);
    return data;
  },
  delete: async (id: string): Promise<void> => {
    await api.delete(`/kra-library/${id}/`);
...
export const kpiLibraryApi = {
  list: async (params?: any): Promise<any[]> => {
    const { data } = await api.get('/kpi-library/', { params });
    return unwrap(data);
  },
  create: async (payload: any): Promise<any> => {
    const { data } = await api.post('/kpi-library/', payload);
    return data;
  },
  update: async (id: string, payload: any): Promise<any> => {
    const { data } = await api.patch(`/kpi-library/${id}/`, payload);
    return data;
  },
  delete: async (id: string): Promise<void> => {
    await api.delete(`/kpi-library/${id}/`);
...
// Departmental KRAs (Old API for old page)
export const deptKRAsApi = deptKRAApi; // Alias
export const deptKPIsApi = {
  create: async (payload: any): Promise<any> => {
    const { data } = await api.post('/dept-kpis/', payload);
    return data;
  },
  update: async (id: string, payload: any): Promise<any> => {
    const { data } = await api.patch(`/dept-kpis/${id}/`, payload);
    return data;
  },
  delete: async (id: string): Promise<void> => {
    await api.delete(`/dept-kpis/${id}/`);
  },
};

export const carryForwardApi = {
  list: async (annualPlanId: string): Promise<CarryForwardRecord[]> => {
    const { data } = await api.get('/carry-forwards/', {
      params: { annual_plan: annualPlanId },
    });
    return Array.isArray(data) ? data : data.results;
  },
  ...
  create: async (payload: {
    ...
    const { data } = await api.post<CarryForwardRecord>('/carry-forwards/', payload);
    return data;
  },

  approve: async (id: string): Promise<{ status: string; message: string }> => {
    const { data } = await api.post(`/carry-forwards/${id}/approve/`);
    return data;
  },

  reject: async (id: string): Promise<{ status: string; message: string }> => {
    const { data } = await api.post(`/carry-forwards/${id}/reject/`);
    return data;
  },
};